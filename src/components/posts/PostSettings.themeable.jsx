/**
 * PostSettings - Themeable Version for Storybook
 * 
 * This version can switch between Native and Mantine UI
 * based on the uiTheme prop (controlled by Storybook toolbar)
 */
...
export const PostSettings = ({ 
  ...
  collapsed,
  onToggle,
  uiTheme = 'native' // Can be 'native' or 'mantine'
}) => {
